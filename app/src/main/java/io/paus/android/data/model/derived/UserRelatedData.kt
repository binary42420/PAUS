...
import io.paus.android.data.extensions.getTimezone
import io.paus.android.data.invalidation.Observer
import io.paus.android.data.invalidation.Table
import io.paus.android.data.model.CategoryApp
...
data class UserRelatedData(
    ...
    companion object {
        ...
        private val relatedTables = arrayOf(
                Table.User, Table.Category, Table.pausRule,
    ...
    override fun onInvalidated(tables: Set<Table>) {
        tables.forEach {
            when (it) {
                ...
                Table.pausRule -> rulesInvalidated = true
