 ...
 */
package io.paus.android.data.backup
...
object DatabaseBackupLowlevel {
    ...
    private const val PAUS_TIME_RULE = "PausRule"
    ...
    fun outputAsBackupJson(database: Database, outputStream: OutputStream) {
        ...
        handleCollection(PAUS_TIME_RULE) { offset, pageSize -> database.pausRules().getRulePageSync(offset, pageSize) }
            ...
            while (reader.hasNext()) {
                when (reader.nextName()) {
                    ...
                    PAUS_TIME_RULE -> {
                        ...
                        while (reader.hasNext()) {
                            database.pausRules().addPausRule(PausRule.parse(reader))
                        }
