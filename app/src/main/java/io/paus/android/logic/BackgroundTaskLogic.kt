...
import io.paus.android.coroutines.runAsyncExpectForever
import io.paus.android.data.backup.DatabaseBackup
import io.paus.android.data.model.ExperimentalFlags
import io.paus.android.data.model.ManipulationFlag
...
import io.paus.android.extensions.nextBlockedMinuteOfWeek
import io.paus.android.integration.platform.*
import io.paus.android.integration.platform.android.AccessibilityService
import io.paus.android.livedata.*
import io.paus.android.logic.blockingreason.AppBaseHandling
import io.paus.android.logic.blockingreason.CategoryHandlingCache
import io.paus.android.logic.blockingreason.CategoryItselfHandling
import io.paus.android.sync.actions.UpdateDeviceStatusAction
import io.paus.android.sync.actions.apply.ApplyActionUtil
import io.paus.android.ui.lock.LockActivity
import io.paus.android.util.AndroidVersion
                ...
                fun buildNotificationForAppWithCategoryUsage(
                    ...
                    return if (handling.areLimitsTemporarilyDisabled) {
                        buildStatusMessageWithCurrentAppTitle(
                                text = appLogic.context.getString(R.string.background_logic_pauses_disabled),
                        ...
                        buildStatusMessageWithCurrentAppTitle(
                                text = appLogic.context.getString(R.string.background_logic_no_Paus),
                                titlePrefix = titlePrefix,
                                titleSuffix = suffix,
                                appPackageName = appPackageName,
                                appActivityToShow = appActivityToShow
