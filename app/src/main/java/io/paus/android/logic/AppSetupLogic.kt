...
import io.paus.android.data.devicename.DeviceName
...
import io.paus.android.ui.setup.SetupUnprovisionedCheck
import io.paus.android.ui.user.create.DefaultCategories
        ...
        Threads.database.executeAndWait(Runnable {
            ...
            appLogic.database.runInTransaction {
                ...
                run {
                    ...
                    // add default paus rules
                    defaultCategories.generateGamesPausRules(allowedGamesCategoryId).forEach { rule ->
                        appLogic.database.pausRules().addPausRule(rule)
                    }
                }
            }
        })
