...
class ConfirmEnableLimitsAgainDialogFragment: DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return AlertDialog.Builder(requireContext(), theme)
            .setTitle(R.string.manage_child_confirm_enable_pauses_again_title)
            .setMessage(getString(R.string.manage_child_confirm_enable_pauses_again_text, ""))
            ...
            .also { alert ->
                ...
                { category ->
                    if (category == null) dismissAllowingStateLoss()
                        ...
                        R.string.manage_child_confirm_enable_pauses_again_text,
                        category.title
                    ))
                }
            }
