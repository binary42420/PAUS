...
import io.paus.android.databinding.AddItemViewBinding
import io.paus.android.databinding.CategoryRichCardBinding
import io.paus.android.databinding.IntroCardBinding
import io.paus.android.ui.util.DateUtil
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when (item) {
            is CategoryItem -> {
                ...
                binding.pausesDisabledUntil = if (item.mode is CategorySpecialMode.TemporarilyAllowed)
