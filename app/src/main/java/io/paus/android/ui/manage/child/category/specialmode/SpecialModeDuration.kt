...
sealed class SpecialModeOption {
    ...
    object UntilTimeOption: SpecialModeOption() {
        override fun getLabel(context: Context): String = context.getString(R.string.manage_disable_time_pauses_btn_time)
    }

    object UntilDateOption: SpecialModeOption() {
        override fun getLabel(context: Context): String = context.getString(R.string.manage_disable_time_pauses_btn_date)
    }

    object NoEndTimeOption: SpecialModeOption() {
        override fun getLabel(context: Context): String = context.getString(R.string.manage_disable_time_pauses_btn_no_end_time)
    }
    ...
    abstract class Duration: SpecialModeOption() {
        ...
        class FixedEndTime(val timestamp: Long): Duration() {
            override fun getLabel(context: Context): String = context.getString(
                    R.string.manage_disable_time_pauses_btn_until,
...
object SpecialModeDuration {
    val items = listOf(
            ...
            SpecialModeOption.Duration.FixedDuration(R.string.manage_disable_time_pauses_btn_30_min, 1000 * 60 * 30),
            SpecialModeOption.Duration.FixedDuration(R.string.manage_disable_time_pauses_btn_1_hour, 1000 * 60 * 60 * 1),
            SpecialModeOption.Duration.FixedDuration(R.string.manage_disable_time_pauses_btn_2_hour, 1000 * 60 * 60 * 2),
            SpecialModeOption.Duration.FixedDuration(R.string.manage_disable_time_pauses_btn_4_hour, 1000 * 60 * 60 * 4),
            SpecialModeOption.Duration.Days(R.string.manage_disable_time_pauses_btn_today, 1),
